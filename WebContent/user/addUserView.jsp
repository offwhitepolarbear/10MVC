...
<head>
	...
	function checkId(){
		...
		//idGuide.test(id) 저거로만 되있으면 트루뜸

			//return idGuide.test(id);
	...
	$("input[type='password']").on("keyup" , function() {
		...
		$(".password").text("비밀번호가 다릅니다.");
				...
				var test2 = JSON.stringify(test);
					 ...
					 $.ajax( 
								{
									...
									success : function(serverData , status) {
										...
										if(JSONData){
											...
											var memo = "<td id=checkId>가입 가능합니다.</td>";
											$("#memo").remove();
											$("#checkId").html(memo);
										}
										if(!JSONData){
											
											var memo = "<td id=checkId>중복된 ID 가입 불가능합니다.</td>";
											$("#memo").remove();
											$("#checkId").html(memo);
										}
									}	 
				 ...
				 if(!checker){
					 var memo = "<td id=checkId>유효한 id 양식이 아닙니다</td>";
						$("#memo").remove();
						$("#checkId").html(memo);
				 }
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:13px;">
					...
					<td>
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td align="center" background="/images/ct_btng02.gif" class="ct_btn" style="padding-top:3px;" id="checkId">
	...
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6" class="password" style="color: navy ; font-size: 12pt; font-weight: bolder;"></td>
